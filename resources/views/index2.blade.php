                                        ...
                                        <div class="tab-content" id="v-pills-tabContent">
                                            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                                <div class="imge-thumb-vedio">
                                                    <img src="{{ asset('assets/images/steps/04.png') }}" alt="" loading="lazy">
            ...
            <div class="row g-5 mt--5">
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-team-area">
                        <img src="{{ asset('assets/images/team/brand/quote.png') }}" alt="" loading="lazy" class="quote">
                        <div class="star">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <!-- ..:: single team area start ::.. -->
                    <div class="single-team-area">
                        <img src="{{ asset('assets/images/team/brand/quote.png') }}" alt="images" loading="lazy" class="quote">
                        <div class="star">
                            <i class="fa-sharp fa-solid fa-star"></i>
                            <i class="fa-sharp fa-solid fa-star"></i>
                            <i class="fa-sharp fa-solid fa-star"></i>
                        ...
                        <div class="inner-content">
                            ...
                            <div class="body">
                                ...
                                <div class="author-area">
                                    ...
                                    <a href="{{ route('blogdetails') }}">Read More <i class="fa-solid fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
