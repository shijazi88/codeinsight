            ...
            <div class="row mt--25 g-5">
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-tools-feature">
                        ...
                        <a href="{{ route('usecase') }}" class="rts-btn btn-lonly">Try Blog Content <i class="fa-regular fa-arrow-right"></i></a>
                    </div>
                    <!-- ..:: sngle tools featuer ::.. -->
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-tools-feature">
                        ...
                        <a href="{{ route('usecase') }}" class="rts-btn btn-lonly">Try Social Content <i class="fa-regular fa-arrow-right"></i></a>
                    </div>
                    <!-- ..:: sngle tools featuer ::.. -->
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-tools-feature">
                        ...
                        <a href="{{ route('usecase') }}" class="rts-btn btn-lonly">Try eCommerce Copy<i class="fa-regular fa-arrow-right"></i></a>
                    </div>
                    <!-- ..:: sngle tools featuer ::.. -->
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-tools-feature">
                        ...
                        <a href="{{ route('usecase') }}" class="rts-btn btn-lonly">Try Sales Copy<i class="fa-regular fa-arrow-right"></i></a>
                    </div>
                    <!-- ..:: sngle tools featuer ::.. -->
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-tools-feature">
                        ...
                        <a href="{{ route('usecase') }}" class="rts-btn btn-lonly">Try Website Copy<i class="fa-regular fa-arrow-right"></i></a>
                    </div>
                    <!-- ..:: sngle tools featuer ::.. -->
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
