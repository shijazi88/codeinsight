            ...
            <div class="shape-image">
                <div class="icon-wrapper">
                    <div class="single one">
                        <img src="{{ asset('assets/images/banner/icon/01.png') }}" alt="one-banner" class="one" loading="lazy">
                        <span>Content Writing</span>
                    </div>
                    <div class="single two">
                        <img src="{{ asset('assets/images/banner/icon/02.png') }}" alt="one-banner" class="one" loading="lazy">
        ...
        <div class="case-area-three rts-section-gapBottom">
            ...
            <div class="container">
                ...
                <div class="row g-5 mt--5">
                    ...
                    <div class="col-lg-12">
                        <a href="{{ route('usecase2') }}" class="rts-btn btn-primary mt--30 m-center">View All Use Cases</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="working_p-swiper-main-wrapper">
                                        ...
                                        <div class="row g-5 align-items-center">
                                            <div class="col-lg-6">
                                                <div class="thumbnail-main-wrapper">
                                                    <img src="{{ asset('assets/images/steps/05.svg') }}" alt="images" loading="lazy">
                                                </div>
                                            </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="working-process-main-wrapper">
                                        <div class="row g-5 align-items-center">
                                            <div class="col-lg-6">
                                                <div class="thumbnail-main-wrapper">
                                                    <img src="{{ asset('assets/images/steps/06.svg') }}" alt="images" loading="lazy">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 pl--100 pl_md--50 pl_sm--15">
                                                <div class="steps-main-content-three">
                                ...
                                <div class="swiper-slide">
                                    <div class="working-process-main-wrapper">
                                        <div class="row g-5 align-items-center">
                                            <div class="col-lg-6">
                                                <div class="thumbnail-main-wrapper">
                                                    <img src="{{ asset('assets/images/steps/07.svg') }}" alt="images" loading="lazy">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 pl--100 pl_md--50 pl_sm--15">
                                                <div class="steps-main-content-three">
                        ...
                        <div class="thumbnail-img-left">
                            <img src="{{ asset('assets/images/testimonials/02.png') }}" alt="testimonials" loading="lazy">
                        </div>
                    </div>
                ...
                <div class="row mt--10 g-5">
                    <div class="col-lg-12">
                        ...
                        <ul class="nav nav-button-area-main nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Annually</button>
                            </li>
                        </ul>
                                ...
                                <div class="row g-5">
                                    <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div class="signle-pricing-main-con-three left-area">
                                            <div class="thumbnail-img">
                                                <img src="{{ asset('assets/images/testimonials/01.png') }}" alt="img" loading="lazy">
                                            </div>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="single-prcing-three-main-wrapper">
                                            ...
                                            <div class="body">
                                                <p class="disc">A simple pricing plan includes a set of clearly defined pricing tiers.</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 mt_sm--30">
                                    <div class="thumbnail-three">
                                        <img src="{{ asset('assets/images/cta/05.png') }}" alt="cta" loading="lazy">
                                    </div>
                                </div>
                            </div>
                        </div>
