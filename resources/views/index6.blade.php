        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="content-main-wrapper">
                    ...
                    <p class="disc">
                        Convert words to images with OpenuP AI image generator. Watch your imagination transform into AI-generated images online.
                    </p>
                    <form action="#">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="right-side-content">
                        ...
                        <p class="desc">Discover the mesmerizing realm where human creativity intertwines <br> with the ingenuity of artificial intelligence. Step into a world where <br> stunning visuals are brought the power of AI image generation.</p>
                            ...
                            <li>
                                <span class="video-thumb">
                                    ...
                                    <div class="vedio-icone">
                                        <a class="play-video popup-youtube video-play-button" href="https://www.youtube.com/watch?v=PfxLRA2bJ3A">
                        ...
                        <div class="bottom-wrapper">
                            ...
                            <div class="user-area">
                                <div class="image-wrapper">
                                    <img class="one" src="{{ asset('assets/images/about/10.png') }}" alt="user" loading="lazy">
                                    <img class="two" src="{{ asset('assets/images/about/11.png') }}" alt="user" loading="lazy">
                                    <img class="three" src="{{ asset('assets/images/about/12.png') }}" alt="user" loading="lazy">
                                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="left-side-content">
                        ...
                        <p class="disc">Openup AI image generator from text brings your concept art to life online in just seconds. Text to image tool, allows you to take text prompts and turn them into matching images. Enter text prompts like " a Abstract image transform your creative ideas into stunning images with just a few clicks. </p>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="left-side-content area-2">
                        ...
                        <p class="disc">The process of generating AI images has been simplified through the development of user-friendly tools and platforms. These tools often have user-friendly interfaces that allow users to input parameters and preferences, enabling them to create custom images with ease.</p>
                        <a href="#" class="rts-btn btn-primary">Generate Image</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="rts-heading">
                    <div class="title-inner">
                        ...
                        <p class="disc">The first step in generating AI images is collecting a dataset of <br> real images related to the desired output. For instance.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lgl-12">
                <div class="title-conter-area">
                    ...
                    <p class="disc">Keep in mind that the actual pricing and features of AI services may vary significantly depending on the provider and the specific.</p>
                </div>
            </div>
        </div>
