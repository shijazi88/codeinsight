...
<html lang="en">
    ...
    <x-head headtitle='OpenUp HTML Template'/>
                    ...
                    <div class="content-main-wrapper">
                        ...
                        <div class="user-area">
                            ...
                            <div class="image-wrapper">
                                <img class="one" src="{{ asset('assets/images/banner/user/01.png') }}" alt="user" loading="lazy">
                                <img class="two" src="{{ asset('assets/images/banner/user/02.png') }}" alt="user" loading="lazy">
                                <img class="three" src="{{ asset('assets/images/banner/user/04.png') }}" alt="user" loading="lazy">
                                <img class="four" src="{{ asset('assets/images/banner/user/03.png') }}" alt="user" loading="lazy">
                                <img class="five" src="{{ asset('assets/images/banner/user/05.png') }}" alt="user" loading="lazy">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mt--25 g-5">
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-tools-feature">
                        ...
                        <a href="usecase"class="rts-btn btn-lonly">Try Blog Content <i class="fa-regular fa-arrow-right"></i></a>
                    </div>
                    <!-- ..:: sngle tools featuer ::.. -->
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-tools-feature">
                        ...
                        <a href="usecase"class="rts-btn btn-lonly">Try Social Content <i class="fa-regular fa-arrow-right"></i></a>
                    </div>
                    <!-- ..:: sngle tools featuer ::.. -->
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-tools-feature">
                        ...
                        <a href="usecase"class="rts-btn btn-lonly">Try eCommerce Copy<i class="fa-regular fa-arrow-right"></i></a>
                    </div>
                    <!-- ..:: sngle tools featuer ::.. -->
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-tools-feature">
                        ...
                        <a href="usecase"class="rts-btn btn-lonly">Try Sales Copy<i class="fa-regular fa-arrow-right"></i></a>
                    </div>
                    <!-- ..:: sngle tools featuer ::.. -->
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-tools-feature">
                        ...
                        <a href="usecase"class="rts-btn btn-lonly">Try Website Copy<i class="fa-regular fa-arrow-right"></i></a>
                    </div>
                    <!-- ..:: sngle tools featuer ::.. -->
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
        ...
        <div class="container">
            ...
            <ul class="nav mt--20 nav-tabs pricing-button-one" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class=" active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Monthly</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Annual</button>
                </li>
                ...
                <ul class="mainmenu metismenu" id="mobile-menu-active">
                    <li class="has-droupdown parent">
                        ...
                        <ul class="submenu mm-collapse">
                            ...
                            <li><a class="mobile-menu-link" href="{{ route('index2') }}">Home Two</a></li>
                            <li><a class="mobile-menu-link" href="{{ route('index3') }}">Home Three</a></li>
                            <li><a class="mobile-menu-link" href="{{ route('index4') }}">Home Four</a></li>
                            <li><a class="mobile-menu-link" href="{{ route('index') }}">Home Five</a></li>
                        </ul>
                    </li>
                    <li class="has-droupdown parent">
                        ...
                        <ul class="submenu mm-collapse">
                            ...
                            <li><a class="mobile-menu-link" href="{{ route('usecase') }}">Use Case</a></li>
                            <li><a class="mobile-menu-link" href="{{ route('usecase2') }}">Use Case 2</a></li>
                            <li><a class="mobile-menu-link" href="{{ route('contact') }}case-details">Use Case Details</a></li>
                            <li><a class="mobile-menu-link" href="{{ route('casedetails2') }}">Use Case Details</a></li>
                            <li><a class="mobile-menu-link" href="{{ route('pricing') }}">Pricing</a></li>
                            <li><a class="mobile-menu-link" href="{{ route('pricingtwo') }}">Pricing Two</a></li>
                            <li><a class="mobile-menu-link" href="{{ route('pricingthree') }}">Pricing Three</a></li>
                            <li><a class="mobile-menu-link" href="{{ route('faq') }}">FAQ</a></li>
                            <li><a class="mobile-menu-link" href="{{ route('login') }}">Log In</a></li>
                            <li><a class="mobile-menu-link" href="{{ route('registration') }}">Registration</a></li>
                            <li><a class="mobile-menu-link" href="{{ route('reset') }}">Reset</a></li>
                            <li><a class="mobile-menu-link" href="{{ route('notfound') }}">Not Found</a></li>
                            <!-- ..:: <li class="has-droupdown third-lvl">
                                <a class="main" href="#">Project Details</a>
                                <ul class="submenu-third-lvl mm-collapse">
                                    <li><a href="project-details></a>Project Details</li>
                                    <li><a href="project-details-gallery></a>Project Details Gallery</li>
                                    <li><a href="project-details-vedio></a>Project Details Vedio</li>
                                    <li><a href="project-details-carousel></a>Project Details carousel</li>
                                </ul>
                            </li> ::.. -->
                        </ul>
                    </li>
                    <li class="parent">
                        <a href="{{ route('feature') }}" class="main">Feature</a>
                    </li>
                    <li class="parent">
