                ...
                <div class="col-lg-12">
                    ...
                    <div class="single-feature-area-start index-feature">
                        ...
                        <div class="featue-content-area">
                            ...
                            <h2 class="title">Generate copy in <br>
                                seconds</h2>
                            <p class="disc">
                                Generate many types of content in under 30 seconds by simply inserting a few input
                                fields. Generate blog topic ideas, intros, ad copy, copywriting.
                            </p>
                    ...
                    <div class="single-feature-area-start index-feature bg-red-l">
                        ...
                        <div class="featue-content-area">
                            ...
                            <p class="disc">
                                ...
                                From blog shots (full blog posts) and tweets to sales email generators and marketing
                                copy.
                            </p>
                            <a href="contact class="rts-btn btn-primary">Get Started Free</a>
                        </div>
                        <div class="image-area">
                            <img src="{{ asset('assets/images/feature/08.svg') }}" alt="feature_image"
                                loading="lazy">
                        </div>
                    </div>
                    <!-- ..:: single openup feature area end ::.. -->
                    ...
                    <div class="single-feature-area-start index-feature bg-blue-l">
                        ...
                        <div class="featue-content-area">
                            ...
                            <p class="disc">
                                Choose from emails, social posts, long-form blog posts, and more! Then, just copy and
                                paste the work into your CMS for publishing.
                            </p>
                            <a href="contact class="rts-btn btn-primary">Get Started Free</a>
                        </div>
                    </div>
                    ...
                    <div class="single-tools-feature">
                        <div class="icon">
                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                ...
                                <rect width="50" height="50" rx="4" fill="#3F3EED"
                                    fill-opacity="0.1" />
                                <path
                        ...
                        <a href="usecase"class="rts-btn btn-lonly">Try Blog Content <i
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-tools-feature">
                        <div class="icon">
                            ...
                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <rect width="50" height="50" rx="4" fill="#33B89F"
                                    fill-opacity="0.1" />
                                <path
                        ...
                        <a href="usecase"class="rts-btn btn-lonly">Try Social Content <i
                                class="fa-regular fa-arrow-right"></i></a>
                    </div>
                    <!-- ..:: sngle tools featuer ::.. -->
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-tools-feature">
                        <div class="icon">
                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <rect width="50" height="50" rx="4" fill="#2A85C8"
                                    fill-opacity="0.1" />
                                <path
                        ...
                        <a href="usecase"class="rts-btn btn-lonly">Try eCommerce Copy<i
                                class="fa-regular fa-arrow-right"></i></a>
                    </div>
                    <!-- ..:: sngle tools featuer ::.. -->
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-tools-feature">
                        <div class="icon">
                            ...
                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <rect width="50" height="50" rx="4" fill="#EBA43B"
                                    fill-opacity="0.1" />
                                <path
                        ...
                        <a href="usecase"class="rts-btn btn-lonly">Try Sales Copy<i
                                class="fa-regular fa-arrow-right"></i></a>
                    </div>
                    <!-- ..:: sngle tools featuer ::.. -->
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-tools-feature">
                        <div class="icon">
                            ...
                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <rect width="50" height="50" rx="4" fill="#E331D2"
                                    fill-opacity="0.1" />
                                <path
                        ...
                        <a href="usecase"class="rts-btn btn-lonly">Try Website Copy<i
                                class="fa-regular fa-arrow-right"></i></a>
                    </div>
                    <!-- ..:: sngle tools featuer ::.. -->
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-tools-feature">
                        <div class="icon">
                            ...
                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <rect width="50" height="50" rx="4" fill="#5584FF"
                                    fill-opacity="0.1" />
                                <path
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="copy-right-start-two">
                        <p><a href="https://themeforest.net/user/parvinfotech" target="_blank">Parv Infotech©</a>
                ...
                <ul class="mainmenu metismenu" id="mobile-menu-active">
                    ...
                    <li class="has-droupdown parent">
                        ...
                        <ul class="submenu mm-collapse">
                            ...
                            <li><a class="mobile-menu-link" href="{{ route('contact') }}case-details">Use Case
                                    Details</a></li>
                            <li><a class="mobile-menu-link" href="{{ route('casedetails2') }}">Use Case Details</a>
                            </li>
