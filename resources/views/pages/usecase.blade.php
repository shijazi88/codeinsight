            ...
            <div class="row g-5 mt-10">
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-use-case">
                        ...
                        <a href="case-details" class="more-case-btn">Try Blog Content<i class="fa-regular fa-arrow-right"></i></a>
                    </div>
                    <!-- ..:: single use case end ::.. -->
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
