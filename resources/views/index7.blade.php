            ...
            <div class="product-area">
                <div class="product-item">
                    <div class="product-detail">
                        <div class="product-thumb"> <img src="{{ asset('assets/images/feature/img-21.png') }}" alt="product-thumb"></div>
                ...
                <div class="product-item">
                    <div class="product-detail">
                        <div class="product-thumb"> <img src="{{ asset('assets/images/feature/img-22.png') }}" alt="product-thumb"></div>
                        <div class="item-wrapper">
                ...
                <div class="product-item last-child">
                    <div class="product-detail">
                        <div class="product-thumb"> <img src="{{ asset('assets/images/feature/img-23.png') }}" alt="product-thumb"></div>
                        <div class="item-wrapper">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                    <div class="image-area">
                        ...
                        <span class="crown-tag"> <img src="{{ asset('assets/images/feature/crown.svg') }}" alt=""></span>
                        <ul class="action-button">
                            ...
                            <li class="single-action"><a href="#"><i class="fa-light fa-arrow-down-to-bracket"></i></a></li>
                        </ul>
                        <div class="content">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="copy-right-start-two">
                        <p><a href="https://themeforest.net/user/parvinfotech" target="_blank">Parv Infotech©</a> 2023. All Rights Reserved.</p>
                        <ul>
