                    ...
                    <div class="banner-four-content five">
                        ...
                        <div class="voice-languages-wrapper">
                            ...
                            <div class="img-wrapper">
                                <img class="one" src="{{ asset('assets/images/banner/user/07.png') }}" alt="banner-user" loading="lazy">
                                <img class="two" src="{{ asset('assets/images/banner/user/08.png') }}" alt="banner-user" loading="lazy">
                                <img class="three" src="{{ asset('assets/images/banner/user/09.png') }}" alt="banner-user" loading="lazy">
                                <img class="four" src="{{ asset('assets/images/banner/user/10.png') }}" alt="banner-user" loading="lazy">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="banner-five-thumbnail">
                        ...
                        <div class="single-mp3-start">
                            <img class="man" src="{{ asset('assets/images/banner/08.png') }}" alt="banner" loading="lazy">
                            <div class="mid">
                                <p>Gwyneth Paltrow</p>
                                <span>English Female Voice</span>
                            </div>
                            <div id="ppbutton7" class="ppbutton fa fa-plays icon-play" data-src="{{ asset('assets/images/mp3/02.mp3') }}">
                                <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="single-mp3-start left">
                            ...
                            <div id="ppbutton6" class="ppbutton fa fa-plays icon-play" data-src="{{ asset('assets/images/mp3/03.mp3') }}">
                                <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7 3C7.53125 3 8 3.46875 8 4V12C8 12.5625 7.46875 13 6.96875 13C6.4375 13 6 12.5625 6 12V4C6 3.46875 6.4375 3 7 3ZM1 7C1.53125 7 2 7.46875 2 8C2 8.5625 1.46875 9 0.96875 9C0.4375 9 0 8.5 0 8C0 7.46875 0.4375 7 1 7ZM10 0C10.5312 0 11 0.46875 11 1V15C11 15.5625 10.4688 16 9.96875 16C9.4375 16 9 15.5625 9 15V1C9 0.46875 9.4375 0 10 0ZM4 6C4.53125 6 5 6.46875 5 7V9C5 9.5625 4.46875 10 3.96875 10C3.4375 10 3 9.5625 3 9V7C3 6.46875 3.4375 6 4 6ZM19 7C19.5312 7 20 7.53125 20 8.03125C20 8.5625 19.5312 9 19 9C18.4375 9 18 8.5 18 8C18 7.46875 18.4375 7 19 7ZM13 4C13.5312 4 14 4.46875 14 5V11C14 11.5625 13.4688 12 12.9688 12C12.4375 12 12 11.5625 12 11V5C12 4.46875 12.4375 4 13 4ZM16 2C16.5312 2 17 2.46875 17 3V13C17 13.5625 16.5312 14 15.9688 14C15.4375 14 15 13.5625 15 13V3C15 2.46875 15.4375 2 16 2Z" fill="white" />
                                </svg>
                            </div>
                        ...
                        <div class="mp3-click-icon-banner">
                            <a id="ppbutton1" class="ppbutton fa fa-plays" data-src="{{ asset('assets/images/mp3/01.mp3') }}">
                                <div class="play">
                    ...
                    <div class="about-image-thu-5">
                        ...
                        <div class="small-image-area mt--30">
                            ...
                            <div class="small-image">
                                <img src="{{ asset('assets/images/about/c-img/01.png') }}" alt="countryimage" loading="lazy">
                                <p>Usa English</p>
                            </div>
                            <!-- ..:: single image end ::.. -->
                            <!-- ..:: single image ::.. -->
                            <div class="small-image">
                                <img src="{{ asset('assets/images/about/c-img/02.png') }}" alt="countryimage" loading="lazy">
                                <p>British English</p>
                            </div>
                            <!-- ..:: single image end ::.. -->
                            <!-- ..:: single image ::.. -->
                            <div class="small-image">
                                <img src="{{ asset('assets/images/about/c-img/03.png') }}" alt="countryimage" loading="lazy">
                                <p>Italian</p>
                            </div>
                            <!-- ..:: single image end ::.. -->
                            <!-- ..:: single image ::.. -->
                            <div class="small-image">
                                <img src="{{ asset('assets/images/about/c-img/04.png') }}" alt="countryimage" loading="lazy">
                                <p>Hindi</p>
                            </div>
                            <!-- ..:: single image end ::.. -->
                            <!-- ..:: single image ::.. -->
                            <div class="small-image">
                                <img src="{{ asset('assets/images/about/c-img/05.png') }}" alt="countryimage" loading="lazy">
                                <p>French</p>
                            </div>
                            <!-- ..:: single image end ::.. -->
                            <!-- ..:: single image ::.. -->
                            <div class="small-image">
                                <img src="{{ asset('assets/images/about/c-img/06.png') }}" alt="countryimage" loading="lazy">
                                <p>German</p>
                            </div>
                            <!-- ..:: single image end ::.. -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7">
                                            <div class="thumbnail-image-large">
                                                <img src="{{ asset('assets/images/brand/08.jpg') }}" alt="brand" loading="lazy">
                                            ...
                                            <div class="right-content">
                                                <div class="inner">
                                                    ...
                                                    <div class="bottom-area">
                                                        <div class="authore">
                                                            <img src="{{ asset('assets/images/brand/09.png') }}" alt="brand" loading="lazy">
            ...
            <div class="row mt--30 g-5">
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="signle-voice-generator-case">
                        ...
                        <a href="case-details" class="read-more-btn-c">Learn More <i class="fa-solid fa-arrow-right"></i></a>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="nav-button-voice-bot mt--40">
                        <ul class="nav nav-tabs" id="myTabs" role="tablist">
                            <li role="presentation" id="ppbutton2" class="ppbutton fa fa-plays nav-item" data-src="{{ asset('assets/images/mp3/02.mp3') }}">
                                <div class="nav-link active" id="homes-tab" data-bs-toggle="tab" data-bs-target="#homes" role="tab" aria-controls="homes" aria-selected="true">
                                    <div class="press-area">
                                        <img src="{{ asset('assets/images/team/19.png') }}" alt="tte4am" loading="lazy">
                                        <div class="info">
                                            <h6>Michael</h6>
                            ...
                            <li role="presentation" id="ppbutton3" class="ppbutton fa fa-plays nav-item" data-src="{{ asset('assets/images/mp3/03.mp3') }}">
                                <div class="nav-link" id="profiles-tab" data-bs-toggle="tab" data-bs-target="#profiles" role="tab" aria-controls="profiles" aria-selected="false">
                                    <div class="press-area">
                                        <img src="{{ asset('assets/images/team/20.png') }}" alt="tte4am" loading="lazy">
                                        <div class="info">
                                            <h6>Mr.Alamin</h6>
                                            <span class="one">Emotions</span>
                                            <span class="two">Audiobooks</span>
                            ...
                            <li role="presentation" id="ppbutton4" class="ppbutton fa fa-plays nav-item" data-src="{{ asset('assets/images/mp3/04.mp3') }}">
                                <div class="nav-link" id="contactf-tab" data-bs-toggle="tab" data-bs-target="#contactf" role="tab" aria-controls="contact" aria-selected="false">
                                    <div class="press-area">
                                        <img src="{{ asset('assets/images/team/21.png') }}" alt="tte4am" loading="lazy">
                                        <div class="info">
                                            <h6>Mr.Ashik</h6>
                                            <span class="one">Emotions</span>
                                            <span class="two">Audiobooks</span>
                            ...
                            <li role="presentation" id="ppbutton5" class="ppbutton fa fa-plays nav-item" data-src="{{ asset('assets/images/mp3/01.mp3') }}">
                                <div class="nav-link" id="about-tab" data-bs-toggle="tab" data-bs-target="#about" role="tab" aria-controls="about" aria-selected="false">
                                    <div class="press-area">
                                        <img src="{{ asset('assets/images/team/22.png') }}" alt="tte4am" loading="lazy">
                                        <div class="info">
                                            <h6>Mr.Banna</h6>
                                            <span class="one">Emotions</span>
                                            <span class="two">Audiobooks</span>
                        ...
                        <div class="swiper mySwiper-t4">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <!-- ..:: single swiepr start ::.. -->
                                    <div class="single-team-area">
                                        <img src="{{ asset('assets/images/team/brand/quote.png') }}" alt="img" loading="lazy" class="quote">
                                        <div class="star">
                                            <i class="fa-sharp fa-solid fa-star"></i>
                                            <i class="fa-sharp fa-solid fa-star"></i>
                                            <i class="fa-sharp fa-solid fa-star"></i>
                                ...
                                <div class="swiper-slide">
                                    <!-- ..:: single swiepr start ::.. -->
                                    <div class="single-team-area">
                                        <img src="{{ asset('assets/images/team/brand/quote.png') }}" alt="team" class="quote">
                                        <div class="star">
                                            <i class="fa-sharp fa-solid fa-star"></i>
                                            <i class="fa-sharp fa-solid fa-star"></i>
                                            <i class="fa-sharp fa-solid fa-star"></i>
                                ...
                                <div class="swiper-slide">
                                    <!-- ..:: single swiepr start ::.. -->
                                    <div class="single-team-area">
                                        <img src="{{ asset('assets/images/team/brand/quote.png') }}" alt="img" class="quote">
                                        <div class="star">
                                            <i class="fa-sharp fa-solid fa-star"></i>
                                            <i class="fa-sharp fa-solid fa-star"></i>
                                            <i class="fa-sharp fa-solid fa-star"></i>
